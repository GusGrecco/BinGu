...
export const ReturnCallButton = ({ disabled = false, onClick }: ReturnCallButtonProps) => {
    return (
        <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-md border border-line bg-surface px-4 py-2 text-sm font-bold text-text-primary transition-colors hover:border-accent hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:cursor-not-allowed disabled:border-line disabled:text-text-secondary disabled:hover:border-line disabled:hover:text-text-secondary"
        >
