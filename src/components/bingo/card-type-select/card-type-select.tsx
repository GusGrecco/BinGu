                ...
                {BINGO_CARD_TYPES.map((type) => {
                    ...
                    return (
                        <button
                            ...
                            className={
                                isSelected
                                    ? "cursor-pointer transition-colors select-none rounded-md bg-accent px-3 py-1.5 text-xs font-bold text-surface"
                                    : "cursor-pointer transition-colors select-none rounded-md border border-line bg-transparent px-3 py-1.5 text-xs text-text-secondary hover:border-accent hover:text-accent"
                            }
                        >
